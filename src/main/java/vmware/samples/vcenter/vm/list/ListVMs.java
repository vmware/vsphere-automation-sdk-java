...
public class ListVMs extends SamplesAbstractBase {
	...
	protected void parseArgs(String[] args) {
		Option datacenterOption = Option.builder()
				.longOpt("datacenter")
				.desc("OPTIONAL: Specify the name of the Datacenter to list the"
						+ " Vms available in it.")
				.argName("DATACENTER")
				.required(false)
				.hasArg()
		...
		Option clusterOption = Option.builder()
				.longOpt("cluster")
				.desc("OPTIONAL: Specify the name of the Cluster to list the Vms"
	...
	protected void run() throws Exception {
		com.vmware.vcenter.VMTypes.FilterSpec.Builder bldr = new VMTypes.
				FilterSpec.Builder();
