...
public final class Constants {
    ...
    public static final String EXCEPTION_LOADING_THE_PRIVATE_KEY_CERTIFICATES_FROM_FILES =
            "Exception loading the private key / certificates from files";
    public static final String EXCEPTION_READING_LOADING_THE_USER_CERTIFICATES_FROM_KEYSTORE =
