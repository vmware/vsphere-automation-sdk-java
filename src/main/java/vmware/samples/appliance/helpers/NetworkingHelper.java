...
public class NetworkingHelper {
    ...
    public static void printNetworkInfo(Info networkInfo) {
        ...
        for (Entry<String, InterfaceInfo> interfaceEntry : interfaceInfo
            .entrySet()) {
     ...
     */
    public static void printInterfaceInfo(
        Entry<String, InterfaceInfo> interfaceEntry) {
        System.out.println("--------------------------------");
        System.out.println("Interface information for : " + interfaceEntry
            .getKey());
        System.out.println("--------------------------------");
        System.out.println("Nic Status : " + interfaceEntry.getValue()
            .getStatus());
        ...
        System.out.println("-----------------");
        if (ipv4Info == null) {
            System.out.println("IPv4 information is not available for : "
        ...
        System.out.println("-----------------");
        if (ipv6Info == null) {
            System.out.println("IPv6 information is not available for : "
                               + interfaceEntry.getKey());
        } else {
    ...
    public static void printProxyDetail(String protocol, Config proxyConfig) {
        ...
        if (username != null) {
            ...
            System.out.println("Proxy Password : " + new String(proxyConfig
                .getPassword()));
        }
        System.out.println();
    }
